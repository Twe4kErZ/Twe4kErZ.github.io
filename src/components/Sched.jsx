...
function Sched_template(){
    ...
    return(
        <div className="z-20">
            <h1 className="text-3xl font-bold font-outfit m-2 text-white">Schedule Maker</h1>
            <p className='text-base font-semibold font-outfit m-2 text-white'>This schedule maker utilizes the 24-hour format.</p>
